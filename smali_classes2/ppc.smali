...
.method public static a(Ljava/io/InputStream;Ljava/lang/Integer;Ljava/lang/Integer;ZZZF)Lppa;
    .locals 9
    ...
    .line 11140
    invoke-direct {v4, v3}, Lppj;-><init>(Landroid/graphics/Picture;)V

    .line 330
    invoke-virtual {v4, p1, p2}, Lppj;->a(Ljava/lang/Integer;Ljava/lang/Integer;)V

    .line 331
    const/4 v5, 0x0

    invoke-virtual {v4, v5}, Lppj;->a(Z)V

    .line 332
    const/4 v5, 0x0

    invoke-virtual {v4, v5}, Lppj;->b(Z)V

    .line 333
    invoke-virtual {v4, p6}, Lppj;->a(F)V

    .line 334
    new-instance v5, Lppd;

    invoke-direct {v5, p0}, Lppd;-><init>(Ljava/io/InputStream;)V

    .line 340
    new-instance v6, Lppf;

    .line 21073
    invoke-direct {v6}, Lppf;-><init>()V
    ...
    invoke-virtual {v5}, Lppd;->a()Ljava/io/ByteArrayInputStream;
    ...
    .line 344
    iget-object v6, v6, Lppf;->a:Ljava/util/HashMap;

    iput-object v6, v4, Lppj;->a:Ljava/util/HashMap;
    ...
    iget-object v1, v4, Lppj;->o:Landroid/graphics/RectF;

    invoke-direct {v0, v3, v1}, Lppa;-><init>(Landroid/graphics/Picture;Landroid/graphics/RectF;)V

    .line 352
    iget-object v1, v4, Lppj;->p:Landroid/graphics/RectF;
    ...
    invoke-virtual {v0, v1}, Lppa;->a(Landroid/graphics/RectF;)V
    :try_end_0
    ...
    invoke-direct {v1, v0}, Lbi;-><init>(Ljava/lang/Throwable;)V

    throw v1
.end method

.method static a(Ljava/lang/String;)Lpph;
    .locals 10
    ...
    invoke-direct {v0, v6, v4}, Lpph;-><init>(Ljava/util/ArrayList;I)V
    ...
    invoke-direct {v0, v6, v3}, Lpph;-><init>(Ljava/util/ArrayList;I)V
...
.method static a(Ljava/lang/String;Lorg/xml/sax/Attributes;)Lpph;
    .locals 3
...
.method static b(Ljava/lang/String;)Landroid/graphics/Path;
    ...
    invoke-direct {v0, v1, v4}, Lpoz;-><init>(Ljava/lang/CharSequence;I)V

    .line 572
    invoke-virtual/range {v28 .. v28}, Lpoz;->a()V
    ...
    .line 586
    invoke-virtual/range {v28 .. v28}, Lpoz;->b()V
    ...
    .line 601
    :sswitch_0
    invoke-virtual/range {v28 .. v28}, Lpoz;->c()F
