...
.method public static a(Ljava/io/InputStream;Ljava/lang/Integer;Ljava/lang/Integer;ZZZF)Lpnm;
    .locals 9
    ...
    .line 2140
    invoke-direct {v4, v3}, Lpnv;-><init>(Landroid/graphics/Picture;)V

    .line 330
    invoke-virtual {v4, p1, p2}, Lpnv;->a(Ljava/lang/Integer;Ljava/lang/Integer;)V

    .line 331
    const/4 v5, 0x0

    invoke-virtual {v4, v5}, Lpnv;->a(Z)V

    .line 332
    const/4 v5, 0x0

    invoke-virtual {v4, v5}, Lpnv;->b(Z)V

    .line 333
    invoke-virtual {v4, p6}, Lpnv;->a(F)V

    .line 338
    new-instance v5, Lpnp;

    invoke-direct {v5, p0}, Lpnp;-><init>(Ljava/io/InputStream;)V

    .line 340
    new-instance v6, Lpnr;

    .line 3073
    invoke-direct {v6}, Lpnr;-><init>()V
    ...
    invoke-virtual {v5}, Lpnp;->a()Ljava/io/ByteArrayInputStream;
    ...
    .line 344
    iget-object v6, v6, Lpnr;->a:Ljava/util/HashMap;

    iput-object v6, v4, Lpnv;->a:Ljava/util/HashMap;
    ...
    iget-object v1, v4, Lpnv;->o:Landroid/graphics/RectF;

    invoke-direct {v0, v3, v1}, Lpnm;-><init>(Landroid/graphics/Picture;Landroid/graphics/RectF;)V

    .line 352
    iget-object v1, v4, Lpnv;->p:Landroid/graphics/RectF;
    ...
    invoke-virtual {v0, v1}, Lpnm;->a(Landroid/graphics/RectF;)V
    :try_end_0
    ...
    invoke-direct {v1, v0}, Lbl;-><init>(Ljava/lang/Throwable;)V

    throw v1
.end method

.method static a(Ljava/lang/String;)Lpnt;
    .locals 10
    ...
    invoke-direct {v0, v6, v4}, Lpnt;-><init>(Ljava/util/ArrayList;I)V
    ...
    invoke-direct {v0, v6, v3}, Lpnt;-><init>(Ljava/util/ArrayList;I)V
...
.method static a(Ljava/lang/String;Lorg/xml/sax/Attributes;)Lpnt;
    .locals 3
...
.method static b(Ljava/lang/String;)Landroid/graphics/Path;
    ...
    invoke-direct {v0, v1, v4}, Lpnl;-><init>(Ljava/lang/CharSequence;I)V

    .line 572
    invoke-virtual/range {v28 .. v28}, Lpnl;->a()V
    ...
    .line 586
    invoke-virtual/range {v28 .. v28}, Lpnl;->b()V
    ...
    .line 601
    :sswitch_0
    invoke-virtual/range {v28 .. v28}, Lpnl;->c()F
