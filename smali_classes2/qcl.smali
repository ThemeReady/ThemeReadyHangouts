...
.method public constructor <init>(Lorg/chromium/net/impl/CronetBidirectionalStream;)V
    ...
    .prologue
    .line 153
    iput-object p1, p0, Lqcl;->c:Lorg/chromium/net/impl/CronetBidirectionalStream;
...
.method public run()V
    ...
    .line 163
    :try_start_0
    iget-object v1, p0, Lqcl;->a:Ljava/nio/ByteBuffer;

    .line 164
    const/4 v2, 0x0

    iput-object v2, p0, Lqcl;->a:Ljava/nio/ByteBuffer;

    .line 166
    iget-object v2, p0, Lqcl;->c:Lorg/chromium/net/impl/CronetBidirectionalStream;
    ...
    .line 167
    :try_start_1
    iget-object v3, p0, Lqcl;->c:Lorg/chromium/net/impl/CronetBidirectionalStream;
    ...
    iget-object v4, p0, Lqcl;->c:Lorg/chromium/net/impl/CronetBidirectionalStream;

    .line 7042
    iget-object v4, v4, Lorg/chromium/net/impl/CronetBidirectionalStream;->t:Lqfa;

    .line 177
    iget-boolean v5, p0, Lqcl;->b:Z

    invoke-virtual {v2, v3, v4, v1, v5}, Lqfc;->a(Lqai;Lqbz;Ljava/nio/ByteBuffer;Z)V

    .line 179
    if-eqz v0, :cond_0

    .line 180
    iget-object v0, p0, Lqcl;->c:Lorg/chromium/net/impl/CronetBidirectionalStream;
    ...
    .line 183
    iget-object v1, p0, Lqcl;->c:Lorg/chromium/net/impl/CronetBidirectionalStream;
