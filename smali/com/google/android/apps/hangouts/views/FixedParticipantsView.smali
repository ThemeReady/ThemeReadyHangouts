...
.method public a(Lbjt;Ljava/util/List;)V
    .locals 12
    ...
    .line 83
    iget-object v1, v4, Leht;->a:Lehx;

    .line 1166
    invoke-virtual {v1}, Lehx;->ordinal()I
    ...
    .line 89
    :cond_2
    iget-object v1, v4, Leht;->h:Ljava/lang/String;

    if-eqz v1, :cond_7

    iget-object v1, v4, Leht;->f:Ljava/lang/String;

    if-nez v1, :cond_3

    iget-object v1, v4, Leht;->e:Ljava/lang/String;
    ...
    iget-object v2, v4, Leht;->h:Ljava/lang/String;

    const/4 v3, 0x0

    iget-object v4, v4, Leht;->f:Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v2, p1}, Lcom/google/android/apps/hangouts/views/AvatarView;->a(Ljava/lang/String;ZLbjt;)V

    goto :goto_5

    .line 97
    :cond_8
    iget-object v1, v4, Leht;->b:Lehv;

    invoke-virtual {v0, v1, p1}, Lcom/google/android/apps/hangouts/views/AvatarView;->a(Lehv;Lbjt;)V
    ...
    .line 123
    :cond_12
    invoke-static {v3, v8}, Lsb;->a([Ljava/lang/String;I)Ljava/lang/CharSequence;
