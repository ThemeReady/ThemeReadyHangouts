...
.method private a()Ljavax/net/ssl/SSLSocketFactory;
    ...
    :cond_0
    :try_start_0
    sget-object v0, Lcom/google/android/libraries/stitch/sslguard/SslGuardSocketFactory;->b:Liik;
    ...
    invoke-virtual {v0, v2}, Liik;->a(Landroid/content/Context;)V
    :try_end_0
    .catch Lieh; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 2054
    sget-object v3, Lkfz;->a:Lkfz;

    iget-object v3, v3, Lkfz;->b:Landroid/content/Context;

    .line 2052
    invoke-interface {v2, v0, v3}, Liek;->a(ILandroid/content/Context;)V
...
.method public static a(Liik;Liek;)V
    .locals 2
    ...
    .line 167
    :cond_1
    sput-object p0, Lcom/google/android/libraries/stitch/sslguard/SslGuardSocketFactory;->b:Liik;
