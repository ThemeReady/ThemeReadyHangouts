...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgco;->b:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    sput-object v0, Lgco;->c:Landroid/net/Uri;
...
.method public constructor <init>(Landroid/telephony/SmsManager;)V
    ...
    iput-object v0, p0, Lgco;->e:Ljava/util/concurrent/ConcurrentHashMap;

    .line 47
    iput-object p1, p0, Lgco;->d:Landroid/telephony/SmsManager;

    .line 48
    return-void
.end method

.method private a(Landroid/content/Context;Ljava/lang/String;Lago;Z)Lahf;
    .locals 14
    ...
    invoke-virtual {p0, p1, v0}, Lgco;->a(Landroid/content/Context;Lago;)Landroid/net/Uri;
    ...
    invoke-direct {v6, v3, v0}, Lgcp;-><init>(Landroid/net/Uri;Z)V

    .line 142
    sget-object v2, Lgco;->b:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    .line 149
    :try_start_0
    iget-object v2, p0, Lgco;->e:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 153
    sget-object v4, Lgco;->c:Landroid/net/Uri;
    ...
    invoke-virtual {p0, p1, v3, v0, v5}, Lgco;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-static {v2, v3, v7}, Lgqb;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 6316
    :pswitch_0
    iget-object v2, v6, Lgcp;->a:Landroid/net/Uri;
    ...
    .line 2226
    sget-boolean v3, Lgco;->a:Z

    if-eqz v3, :cond_6

    .line 7316
    iget-object v3, v6, Lgcp;->a:Landroid/net/Uri;
    ...
    .line 8316
    :cond_6
    iget-boolean v2, v6, Lgcp;->b:Z

    if-eqz v2, :cond_7

    .line 9316
    iget-object v2, v6, Lgcp;->f:[B

    .line 2239
    invoke-virtual {p0, v2}, Lgco;->a([B)Lahf;
    ...
    invoke-direct {v2, v3}, Lgcj;-><init>(I)V
...
# virtual methods
.method public a(Landroid/content/Context;Lahg;)Lahf;
    .locals 2
    ...
    invoke-direct {p0, p1, v0, p2, v1}, Lgco;->a(Landroid/content/Context;Ljava/lang/String;Lago;Z)Lahf;
...
.method a([B)Lahf;
    ...
    invoke-direct {v0, p1}, Lagy;-><init>([B)V
...
.method a(Landroid/content/Context;Lago;)Landroid/net/Uri;
    .locals 6
    ...
    invoke-direct {v2, p1, p2}, Lags;-><init>(Landroid/content/Context;Lago;)V

    invoke-virtual {v2}, Lags;->a()[B
    ...
    :goto_1
    invoke-static {v4, v2, v0}, Lgqb;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v0, v2}, Lgcq;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v2, v3, v0}, Lgcj;-><init>(ILjava/lang/Throwable;)V
...
.method public a(JII[B)V
    ...
    .line 82
    iget-object v0, p0, Lgco;->e:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 85
    :try_start_0
    invoke-virtual {v0, p3, p4, p5}, Lgcp;->a(II[B)V
...
.method a(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Landroid/content/Intent;)V
    ...
    .line 250
    iget-object v0, p0, Lgco;->d:Landroid/telephony/SmsManager;

    .line 1415
    sget-object v4, Lgce;->f:Landroid/os/Bundle;
...
.method public a(Landroid/content/Context;[BLjava/lang/String;I)V
    ...
    invoke-direct {v0, v1, p2, v2}, Lago;-><init>(I[BI)V

    .line 122
    const/4 v1, 0x0

    invoke-direct {p0, p1, p3, v0, v1}, Lgco;->a(Landroid/content/Context;Ljava/lang/String;Lago;Z)Lahf;
