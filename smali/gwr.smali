...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgwr;->c:Ljava/lang/String;

    sget v0, Landroid/os/Build$VERSION;->SDK_INT:I

    const-string v0, "androidPackageName"

    sput-object v0, Lgwr;->d:Ljava/lang/String;
    ...
    sput-object v0, Lgwr;->e:Landroid/content/ComponentName;
    ...
    sput-object v0, Lgwr;->f:Landroid/content/ComponentName;

    return-void
.end method

.method static a(Landroid/content/Context;Landroid/content/ComponentName;Lgwu;)Ljava/lang/Object;
    .locals 5
    ...
    invoke-direct {v1}, Lhbn;-><init>()V

    invoke-static {p0}, Lhak;->a(Landroid/content/Context;)Lhak;

    move-result-object v2

    const-string v0, "GoogleAuthUtil"

    invoke-virtual {v2, p1, v1, v0}, Lhak;->a(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-virtual {v1}, Lhbn;->a()Landroid/os/IBinder;

    move-result-object v0

    invoke-interface {p2, v0}, Lgwu;->a(Landroid/os/IBinder;)Ljava/lang/Object;
    :try_end_0
    ...
    invoke-virtual {v2, p1, v1, v3}, Lhak;->b(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)V
...
.method static a(Landroid/content/Context;)V
    ...
    invoke-static {v0}, Lgxv;->e(Landroid/content/Context;)V
    :try_end_0
    ...
    invoke-direct {v1, v2, v3, v0}, Lgwv;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-virtual {v0}, Lgxr;->getMessage()Ljava/lang/String;

    move-result-object v0

    invoke-direct {v1, v0}, Lgwp;-><init>(Ljava/lang/String;)V
...
.method public static c(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
    ...
    invoke-static {p2, v0}, Lacn;->a(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-direct {v1, p1, p2, v0}, Lgws;-><init>(Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)V
...
.method static d(Landroid/content/Context;Ljava/lang/String;)[Landroid/accounts/Account;
    ...
    .line 0
    invoke-virtual {v0, p0}, Lgxq;->b(Landroid/content/Context;)V
