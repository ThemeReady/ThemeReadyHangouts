...
# virtual methods
.method public a(Landroid/util/AttributeSet;)Lya;
    .locals 2
    ...
    invoke-direct {v0, v1, p1}, Lya;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    return-object v0
.end method

.method public a(Landroid/view/ViewGroup$LayoutParams;)Lya;
    .locals 2
    ...
    invoke-direct {v0, p1}, Lya;-><init>(Lya;)V
    ...
    invoke-direct {v0, p1}, Lya;-><init>(Landroid/view/ViewGroup$LayoutParams;)V

    goto :goto_0

    .line 604
    :cond_2
    invoke-virtual {p0}, Landroid/support/v7/widget/ActionMenuView;->b()Lya;
...
.method public a(Lwi;)V
    ...
    .prologue
    .line 635
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->a:Lwi;
...
.method public a(Lwy;Lwj;)V
    ...
    .prologue
    .line 668
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->f:Lwy;

    .line 669
    iput-object p2, p0, Landroid/support/v7/widget/ActionMenuView;->g:Lwj;
...
.method public a(Lxr;)V
    ...
    .prologue
    .line 121
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->e:Lxr;

    .line 122
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->e:Lxr;

    invoke-virtual {v0, p0}, Lxr;->a(Landroid/support/v7/widget/ActionMenuView;)V
...
.method public a(Lyc;)V
    ...
    .prologue
    .line 140
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->l:Lyc;
...
.method public a(Lwm;)Z
    ...
    .prologue
    .line 623
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->a:Lwi;

    const/4 v1, 0x0

    invoke-virtual {v0, p1, v1}, Lwi;->a(Landroid/view/MenuItem;I)Z
...
.method public synthetic b(Landroid/util/AttributeSet;)Labi;
    .locals 1

    .prologue
    .line 47
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/util/AttributeSet;)Lya;
...
.method protected synthetic b(Landroid/view/ViewGroup$LayoutParams;)Labi;
    .locals 1

    .prologue
    .line 47
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/view/ViewGroup$LayoutParams;)Lya;
...
.method protected b()Lya;
    ...
    invoke-direct {v0, v1, v1}, Lya;-><init>(II)V
...
.method public b(Z)V
    ...
    invoke-virtual {v0, v1}, Lxr;->d(Z)V
...
.method public d()Landroid/view/Menu;
    ...
    invoke-direct {v1, v0}, Lwi;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->a:Lwi;

    .line 650
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->a:Lwi;

    new-instance v2, Lyb;

    invoke-direct {v2, p0}, Lyb;-><init>(Landroid/support/v7/widget/ActionMenuView;)V

    invoke-virtual {v1, v2}, Lwi;->a(Lwj;)V

    .line 651
    new-instance v1, Lxr;

    invoke-direct {v1, v0}, Lxr;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->e:Lxr;
    ...
    invoke-virtual {v0, v1}, Lxr;->c(Z)V

    .line 653
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->e:Lxr;

    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->f:Lwy;
    ...
    :goto_0
    invoke-virtual {v1, v0}, Lxr;->a(Lwy;)V
    ...
    invoke-direct {v0, p0}, Lxz;-><init>(Landroid/support/v7/widget/ActionMenuView;)V
...
.method protected synthetic k()Labi;
    .locals 1
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .prologue
    .line 127
    invoke-super {p0, p1}, Labh;->onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v0, v1}, Lxr;->b(Z)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-boolean v5, v0, Lya;->a:Z

    if-nez v5, :cond_b

    .line 515
    iget v5, v0, Lya;->rightMargin:I
...
.method protected onMeasure(II)V
    ...
    iget-object v7, v0, Landroid/support/v7/widget/ActionMenuView;->a:Lwi;
    ...
    iget-object v6, v0, Landroid/support/v7/widget/ActionMenuView;->a:Lwi;

    const/4 v7, 0x1

    invoke-virtual {v6, v7}, Lwi;->b(Z)V
    ...
    iput-boolean v7, v6, Lya;->d:Z

    .line 1230
    const/4 v7, 0x0

    iput v7, v6, Lya;->leftMargin:I

    .line 1231
    const/4 v7, 0x0

    iput v7, v6, Lya;->rightMargin:I
    ...
    :goto_3
    iput-boolean v7, v6, Lya;->e:Z

    .line 1235
    iget-boolean v7, v6, Lya;->a:Z
    ...
    iput-boolean v8, v6, Lya;->f:Z

    .line 1340
    if-nez v9, :cond_11

    iget-boolean v8, v6, Lya;->e:Z
    ...
    iput v9, v6, Lya;->rightMargin:I

    iput v9, v6, Lya;->leftMargin:I
    ...
    .line 171
    :cond_1d
    invoke-super/range {p0 .. p2}, Labh;->onMeasure(II)V
