...
.field public static final aj:Lnq;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/ViewPager;->aj:Lnq;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v4/view/ViewPager;->f:Lnh;
...
.method private a(IIII)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/view/ViewPager;->f(I)Lnh;
...
.method private a(IZIZ)V
    ...
    .line 675
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewPager;->f(I)Lnh;
...
.method private a(Lnh;ILnh;)V
    ...
    .line 1322
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->h:Lly;

    invoke-virtual {v0}, Lly;->b()I
...
.method private b(Z)V
    ...
    .line 2016
    iget-boolean v5, v0, Lnh;->c:Z

    if-eqz v5, :cond_2

    .line 2018
    iput-boolean v2, v0, Lnh;->c:Z
...
.method private b(F)Z
    ...
    iget-object v9, p0, Landroid/support/v4/view/ViewPager;->h:Lly;

    invoke-virtual {v9}, Lly;->b()I
    ...
    .line 2357
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->R:Lqv;
    ...
    invoke-virtual {v1, v0}, Lqv;->a(F)Z
    ...
    .line 2363
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->S:Lqv;
    ...
    invoke-virtual {v2, v0}, Lqv;->a(F)Z
...
.method private h(I)Z
    ...
    .line 1852
    :cond_2
    invoke-direct {p0}, Landroid/support/v4/view/ViewPager;->k()Lnh;
...
.method private i()V
    ...
    sget-object v1, Landroid/support/v4/view/ViewPager;->aj:Lnq;
...
.method private i(I)V
    ...
    .prologue
    .line 1960
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->ab:Lnk;
    ...
    .line 1971
    :cond_2
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->ac:Lnk;
...
.method private j()Z
    ...
    .line 12684
    :cond_0
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->R:Lqv;

    invoke-virtual {v0}, Lqv;->c()Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->S:Lqv;
...
.method private k()Lnh;
    ...
    .line 2394
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->f:Lnh;
...
.method a(II)Lnh;
    ...
    .line 1034
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->h:Lly;

    invoke-virtual {v1, p0, p1}, Lly;->a(Landroid/view/ViewGroup;I)Ljava/lang/Object;

    move-result-object v1

    iput-object v1, v0, Lnh;->a:Ljava/lang/Object;
...
.method a(Landroid/view/View;)Lnh;
    .locals 4
    ...
    .line 1534
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->h:Lly;

    iget-object v3, v0, Lnh;->a:Ljava/lang/Object;

    invoke-virtual {v2, p1, v3}, Lly;->a(Landroid/view/View;Ljava/lang/Object;)Z
...
.method a()V
    ...
    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->R:Lqv;
    ...
    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->S:Lqv;
    ...
    invoke-direct {v0, p0}, Lnj;-><init>(Landroid/support/v4/view/ViewPager;)V
    ...
    .line 423
    invoke-static {p0, v4}, Lmj;->c(Landroid/view/View;I)V

    .line 427
    :cond_0
    new-instance v0, Llsp;

    invoke-direct {v0, p0}, Llsp;-><init>(Landroid/support/v4/view/ViewPager;)V

    invoke-static {p0, v0}, Lmj;->a(Landroid/view/View;Llx;)V
...
.method public a(I)V
    ...
    .line 493
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->ae:Lnl;
    ...
    invoke-static {v5, v2, v6}, Lmj;->a(Landroid/view/View;ILandroid/graphics/Paint;)V
...
.method protected a(IFI)V
    ...
    .line 1935
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->ae:Lnl;

    invoke-virtual {v5, v3, v0}, Lnl;->a(Landroid/view/View;F)V
...
.method public a(Lly;)V
    ...
    invoke-virtual {v0, v5}, Lly;->a(Landroid/database/DataSetObserver;)V

    .line 508
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->h:Lly;

    invoke-virtual {v0, p0}, Lly;->a(Landroid/view/ViewGroup;)V
    ...
    .line 511
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->h:Lly;

    iget v4, v0, Lnh;->b:I

    iget-object v0, v0, Lnh;->a:Ljava/lang/Object;

    invoke-virtual {v3, p0, v4, v0}, Lly;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, p0}, Lly;->b(Landroid/view/ViewGroup;)V
    ...
    .line 520
    :cond_3
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->h:Lly;
    ...
    .line 525
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->o:Lnm;
    ...
    invoke-direct {v0, p0}, Lnm;-><init>(Landroid/support/v4/view/ViewPager;)V

    iput-object v0, p0, Landroid/support/v4/view/ViewPager;->o:Lnm;

    .line 528
    :cond_4
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->h:Lly;

    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->o:Lnm;

    invoke-virtual {v0, v1}, Lly;->a(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {v0, v1, v3}, Lly;->a(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
...
.method public a(Lnk;)V
    ...
    .prologue
    .line 708
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->ab:Lnk;
...
.method public a(ZLnl;)V
    ...
    invoke-virtual {p0, v0, p2, v1}, Landroid/support/v4/view/ViewPager;->a(ZLnl;I)V

    .line 770
    return-void
.end method

.method public a(ZLnl;I)V
    .locals 5
    ...
    .line 793
    :goto_0
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->ae:Lnl;
    ...
    .line 794
    :goto_2
    iput-object p2, p0, Landroid/support/v4/view/ViewPager;->ae:Lnl;
...
.method public a(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v1, v2}, Lky;->b(I)Z
    ...
    invoke-virtual {v1, v2, v3}, Lky;->a(II)Z
...
.method protected a(Landroid/view/View;ZIII)Z
    ...
    invoke-static {p1, v0}, Lmj;->a(Landroid/view/View;I)Z
...
.method public addFocusables(Ljava/util/ArrayList;II)V
    ...
    .line 2926
    invoke-virtual {p0, v3}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lnh;
...
.method public addTouchables(Ljava/util/ArrayList;)V
    ...
    .line 2966
    invoke-virtual {p0, v1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lnh;
...
.method b(Landroid/view/View;)Lnh;
    .locals 2
    ...
    .line 1549
    :cond_2
    invoke-virtual {p0, p1}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lnh;
...
.method public d()V
    ...
    .line 1056
    iget-object v7, p0, Landroid/support/v4/view/ViewPager;->h:Lly;

    iget-object v9, v0, Lnh;->a:Ljava/lang/Object;

    invoke-virtual {v7, v9}, Lly;->b(Ljava/lang/Object;)I
    ...
    .line 1067
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->h:Lly;

    invoke-virtual {v4, p0}, Lly;->a(Landroid/view/ViewGroup;)V

    move v4, v1

    .line 1071
    :cond_0
    iget-object v6, p0, Landroid/support/v4/view/ViewPager;->h:Lly;

    iget v7, v0, Lnh;->b:I

    iget-object v9, v0, Lnh;->a:Ljava/lang/Object;

    invoke-virtual {v6, p0, v7, v9}, Lly;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 2457
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->R:Lqv;

    invoke-virtual {v3, v0, v2}, Lqv;->a(II)V
    ...
    .line 2468
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->S:Lqv;

    invoke-virtual {v4, v3, v2}, Lqv;->a(II)V
...
.method e(I)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->f(I)Lnh;
    ...
    iget-object v2, v0, Landroid/support/v4/view/ViewPager;->h:Lly;
    ...
    invoke-virtual {v2, v0}, Lly;->a(Landroid/view/ViewGroup;)V
    ...
    iget-object v4, v0, Landroid/support/v4/view/ViewPager;->h:Lly;

    invoke-virtual {v4}, Lly;->b()I
    ...
    invoke-virtual {v0, v2, v4}, Landroid/support/v4/view/ViewPager;->a(II)Lnh;
    ...
    iget-object v14, v0, Landroid/support/v4/view/ViewPager;->h:Lly;

    iget-object v2, v2, Lnh;->a:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v14, v0, v8, v2}, Lly;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v8, v2}, Landroid/support/v4/view/ViewPager;->a(II)Lnh;
    ...
    iget-object v10, v0, Landroid/support/v4/view/ViewPager;->h:Lly;

    iget-object v2, v2, Lnh;->a:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v10, v0, v8, v2}, Lly;->a(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v8, v6}, Landroid/support/v4/view/ViewPager;->a(II)Lnh;
    ...
    invoke-direct {v0, v9, v7, v3}, Landroid/support/v4/view/ViewPager;->a(Lnh;ILnh;)V

    .line 1266
    :cond_16
    move-object/from16 v0, p0

    iget-object v3, v0, Landroid/support/v4/view/ViewPager;->h:Lly;
    ...
    iget-object v2, v9, Lnh;->a:Ljava/lang/Object;

    :goto_11
    move-object/from16 v0, p0

    invoke-virtual {v3, v0, v4, v2}, Lly;->b(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v2, v0}, Lly;->b(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v0, v5}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lnh;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->b(Landroid/view/View;)Lnh;
    ...
    invoke-virtual {v0, v3}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lnh;
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Lni;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, v0, Landroid/support/v4/view/ViewPager;->h:Lly;
...
.method protected onLayout(ZIIII)V
    ...
    .line 1774
    iget-boolean v10, v1, Lni;->a:Z

    if-nez v10, :cond_2

    move-object/from16 v0, p0

    invoke-virtual {v0, v8}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lnh;
...
.method protected onRequestFocusInDescendants(ILandroid/graphics/Rect;)Z
    ...
    .line 2996
    invoke-virtual {p0, v5}, Landroid/support/v4/view/ViewPager;->a(Landroid/view/View;)Lnh;
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iget-object v1, p1, Lnn;->d:Landroid/os/Parcelable;

    iget-object v2, p1, Lnn;->e:Ljava/lang/ClassLoader;

    invoke-virtual {v0, v1, v2}, Lly;->a(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
    ...
    .line 1485
    iget-object v0, p1, Lnn;->d:Landroid/os/Parcelable;

    iput-object v0, p0, Landroid/support/v4/view/ViewPager;->k:Landroid/os/Parcelable;

    .line 1486
    iget-object v0, p1, Lnn;->e:Ljava/lang/ClassLoader;
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0}, Lnn;-><init>(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v0}, Lly;->a()Landroid/os/Parcelable;

    move-result-object v0

    iput-object v0, v1, Lnn;->d:Landroid/os/Parcelable;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {v0, v1}, Lmf;->a(Landroid/view/VelocityTracker;I)F
