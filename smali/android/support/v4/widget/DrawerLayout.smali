...
# static fields
.field public static final M:Lqj;
...
.field public final j:Lrn;

.field public final k:Lrn;

.field public final l:Lqq;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->M:Lqj;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Lqi;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->d:Lqi;
    ...
    invoke-direct {v2, p0, v3}, Lqq;-><init>(Landroid/support/v4/widget/DrawerLayout;I)V

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lqq;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lqq;

    .line 383
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lqq;

    invoke-static {p0, v5, v2}, Lrn;->a(Landroid/view/ViewGroup;FLrq;)Lrn;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->j:Lrn;

    .line 384
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->j:Lrn;

    invoke-virtual {v2, v4}, Lrn;->a(I)V

    .line 385
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->j:Lrn;

    invoke-virtual {v2, v1}, Lrn;->a(F)V

    .line 386
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lqq;

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->j:Lrn;

    invoke-virtual {v2, v3}, Lqq;->a(Lrn;)V

    .line 388
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lqq;

    invoke-static {p0, v5, v2}, Lrn;->a(Landroid/view/ViewGroup;FLrq;)Lrn;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lrn;

    .line 389
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lrn;

    const/4 v3, 0x2

    invoke-virtual {v2, v3}, Lrn;->a(I)V
    ...
    .line 391
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lqq;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lrn;

    invoke-virtual {v1, v2}, Lqq;->a(Lrn;)V
    ...
    invoke-direct {v1, p0}, Lqh;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    invoke-static {p0, v1}, Lmj;->a(Landroid/view/View;Lkc;)V

    .line 10199
    sget-object v1, Lmz;->a:Lnb;

    const/4 v2, 0x0

    invoke-virtual {v1, p0, v2}, Lnb;->a(Landroid/view/ViewGroup;Z)V

    .line 10200
    invoke-static {p0}, Lmj;->o(Landroid/view/View;)Z
    ...
    .line 402
    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->M:Lqj;

    invoke-interface {v1, p0}, Lqj;->a(Landroid/view/View;)V

    .line 403
    sget-object v1, Landroid/support/v4/widget/DrawerLayout;->M:Lqj;

    invoke-interface {v1, p1}, Lqj;->a(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
...
.method private static a(Landroid/graphics/drawable/Drawable;I)Z
    ...
    invoke-static {p0}, Lhc;->b(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 1174
    :cond_1
    invoke-static {p0, p1}, Lhc;->b(Landroid/graphics/drawable/Drawable;I)Z
...
.method private c(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v3}, Lmj;->c(Landroid/view/View;I)V
...
.method public a(II)V
    ...
    .line 618
    invoke-static {p2, v0}, Lks;->a(II)I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->j:Lrn;

    .line 639
    :goto_1
    invoke-virtual {v0}, Lrn;->e()V
    ...
    .line 638
    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lrn;
...
.method public a(ILandroid/view/View;)V
    ...
    .line 804
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lrn;

    invoke-virtual {v3}, Lrn;->a()I
...
.method a(Landroid/view/View;F)V
    ...
    invoke-virtual {v0, p1, p2}, Lqm;->a(Landroid/view/View;F)V
...
.method public a(Landroid/view/View;Z)V
    ...
    invoke-virtual {v0, p1, v2, v1}, Lrn;->a(Landroid/view/View;II)Z
    ...
    .line 1619
    invoke-virtual {v0, p1, v1, v2}, Lrn;->a(Landroid/view/View;II)Z
...
.method public a(Lqm;)V
    ...
    .prologue
    .line 535
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->w:Lqm;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/widget/DrawerLayout;->c(Lqm;)V
    ...
    .line 539
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/DrawerLayout;->b(Lqm;)V

    .line 543
    :cond_1
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->w:Lqm;
...
.method a(Z)V
    ...
    .line 1569
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->j:Lrn;
    ...
    .line 1569
    invoke-virtual {v7, v5, v6, v8}, Lrn;->a(Landroid/view/View;II)Z
    ...
    .line 1572
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lrn;
    ...
    .line 1572
    invoke-virtual {v6, v5, v7, v8}, Lrn;->a(Landroid/view/View;II)Z
    ...
    .line 1579
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->l:Lqq;

    invoke-virtual {v0}, Lqq;->a()V

    .line 1580
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->m:Lqq;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, v0}, Lmj;->c(Landroid/view/View;I)V
    ...
    .line 1990
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->d:Lqi;

    invoke-static {p1, v0}, Lmj;->a(Landroid/view/View;Lkc;)V
...
.method c(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1}, Lqm;->a(Landroid/view/View;)V
...
.method public computeScroll()V
    ...
    invoke-virtual {v0, v4}, Lrn;->a(Z)Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lrn;

    invoke-virtual {v1, v4}, Lrn;->a(Z)Z
...
.method public g(Landroid/view/View;)Z
    ...
    .line 1423
    invoke-static {p1}, Lmj;->d(Landroid/view/View;)I

    move-result v2

    .line 1422
    invoke-static {v0, v2}, Lks;->a(II)I
...
.method protected generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, v1}, Lqn;-><init>(II)V
...
.method public generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Lqn;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Lqn;-><init>(Lqn;)V
    ...
    invoke-direct {v0, p1}, Lqn;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
    ...
    invoke-direct {v0, p1}, Lqn;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 1344
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->M:Lqj;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->F:Ljava/lang/Object;

    invoke-interface {v0, v1}, Lqj;->a(Ljava/lang/Object;)I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v3, p1}, Lrn;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->k:Lrn;

    .line 1441
    invoke-virtual {v4, p1}, Lrn;->a(Landroid/view/MotionEvent;)Z
    ...
    .line 1452
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->j:Lrn;

    float-to-int v0, v0

    float-to-int v4, v4

    invoke-virtual {v5, v0, v4}, Lrn;->b(II)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Lrn;->c(I)Z
...
.method protected onLayout(ZIIII)V
    ...
    .line 1193
    iget v1, v0, Lqn;->leftMargin:I

    iget v2, v0, Lqn;->topMargin:I

    iget v3, v0, Lqn;->leftMargin:I
    ...
    .line 1217
    iget v4, v0, Lqn;->topMargin:I

    add-int/2addr v9, v2

    iget v11, v0, Lqn;->topMargin:I
    ...
    .line 1224
    iget v10, v0, Lqn;->bottomMargin:I
    ...
    iget v11, v0, Lqn;->bottomMargin:I
    ...
    iget v13, v0, Lqn;->bottomMargin:I
...
.method protected onMeasure(II)V
    ...
    invoke-static {v6, v8}, Lks;->a(II)I

    move-result v6

    .line 1068
    invoke-static {v10}, Lmj;->o(Landroid/view/View;)Z
    ...
    .line 1069
    sget-object v11, Landroid/support/v4/widget/DrawerLayout;->M:Lqj;

    iget-object v12, p0, Landroid/support/v4/widget/DrawerLayout;->F:Ljava/lang/Object;

    invoke-interface {v11, v10, v12, v6}, Lqj;->a(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    .line 1077
    iget v6, v0, Lqn;->leftMargin:I

    sub-int v6, v2, v6

    iget v11, v0, Lqn;->rightMargin:I
    ...
    invoke-interface {v11, v0, v12, v6}, Lqj;->a(Landroid/view/ViewGroup$MarginLayoutParams;Ljava/lang/Object;I)V
    ...
    invoke-virtual {v6, v10}, Lms;->C(Landroid/view/View;)F
    ...
    invoke-static {v10, v6}, Lmj;->f(Landroid/view/View;F)V
    ...
    iget v12, v0, Lqn;->bottomMargin:I

    add-int/2addr v11, v12

    iget v0, v0, Lqn;->height:I
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v6, v0}, Lqo;-><init>(Landroid/os/Parcelable;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, Lrn;->b(Landroid/view/MotionEvent;)V
    ...
    .line 1505
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->j:Lrn;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Lrn;->b(II)Landroid/view/View;
