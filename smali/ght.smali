...
.method public constructor <init>()V
    ...
    invoke-virtual {p0, p0, v0}, Lght;->attachInterface(Landroid/os/IInterface;Ljava/lang/String;)V
...
.method public a()I
    ...
    .prologue
    .line 59
    iget-object v0, p0, Lght;->b:Landroid/content/Context;
...
.method public a(Ljava/lang/String;)Landroid/os/Bundle;
    ...
    .line 29
    iget-object v1, p0, Lght;->b:Landroid/content/Context;

    invoke-static {v1, p1}, Lgre;->c(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    :try_start_0
    invoke-virtual {p0, v1}, Lght;->b(Ljava/lang/String;)Lfem;
    ...
    invoke-static {v1}, Lgre;->f(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 42
    invoke-virtual {v2}, Lfem;->h()Ljava/lang/String;
    ...
    iget-object v3, p0, Lght;->b:Landroid/content/Context;

    sget v4, Lcom/google/android/apps/hangouts/hangout/StressMode;->zj:I
    ...
    sget v4, Lcom/google/android/apps/hangouts/hangout/StressMode;->zk:I
    ...
    :try_end_1
    .catch Lgmg; {:try_start_1 .. :try_end_1} :catch_0
...
.method public b(Ljava/lang/String;)Lfem;
    .locals 8
    ...
    .line 66
    iget-object v4, p0, Lght;->b:Landroid/content/Context;

    iget v5, p0, Lght;->a:I

    invoke-static {v4, v0, v5, p1}, Lcom/google/android/apps/hangouts/realtimechat/RealTimeChatService;->d(Landroid/content/Context;Lfsz;ILjava/lang/String;)V

    .line 67
    new-instance v4, Lgmh;

    invoke-direct {v4, v3, v2, v1}, Lgmh;-><init>(I[Lfem;Ljava/util/concurrent/Semaphore;)V

    .line 68
    :try_start_0
    invoke-static {v4}, Lcom/google/android/apps/hangouts/realtimechat/RealTimeChatService;->a(Lfpn;)V
    ...
    .line 74
    invoke-static {v4}, Lcom/google/android/apps/hangouts/realtimechat/RealTimeChatService;->b(Lfpn;)V
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 15
    invoke-interface {p0, v1}, Lkj;->a(Ljava/lang/String;)Landroid/os/Bundle;
