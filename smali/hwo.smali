...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lhwo;->a:Ljava/util/Map;
    ...
    sget-object v0, Lhwo;->a:Ljava/util/Map;
    ...
    sput-object v0, Lhwo;->b:Landroid/os/Handler;

    const/4 v0, 0x0

    new-array v0, v0, [Ljava/lang/String;

    sput-object v0, Lhwo;->c:[Ljava/lang/String;
    ...
    sput-object v0, Lhwo;->d:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lhwo;->e:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lhwo;->f:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lhwo;->g:Ljava/util/regex/Pattern;

    const-string v0, "\u0001"

    sput-object v0, Lhwo;->h:Ljava/lang/String;

    const-string v0, "\u0002"

    sput-object v0, Lhwo;->i:Ljava/lang/String;

    new-instance v0, Ljava/security/SecureRandom;

    invoke-direct {v0}, Ljava/security/SecureRandom;-><init>()V

    sput-object v0, Lhwo;->j:Ljava/security/SecureRandom;

    new-instance v0, Lhwp;

    invoke-direct {v0}, Lhwp;-><init>()V

    sput-object v0, Lhwo;->k:Ljava/lang/ThreadLocal;

    new-instance v0, Lhwq;

    invoke-direct {v0}, Lhwq;-><init>()V

    sput-object v0, Lhwo;->l:Ljava/lang/ThreadLocal;

    new-instance v0, Lhwr;

    invoke-direct {v0}, Lhwr;-><init>()V

    sput-object v0, Lhwo;->m:Ljava/lang/ThreadLocal;

    new-instance v0, Lhws;

    invoke-direct {v0}, Lhws;-><init>()V

    sput-object v0, Lhwo;->n:Ljava/lang/ThreadLocal;

    new-instance v0, Lhwt;

    invoke-direct {v0}, Lhwt;-><init>()V

    sput-object v0, Lhwo;->o:Ljava/lang/ThreadLocal;

    new-instance v0, Lhwu;

    invoke-direct {v0}, Lhwu;-><init>()V

    sput-object v0, Lhwo;->p:Ljava/lang/ThreadLocal;
...
.method public static a()Ljava/lang/StringBuilder;
    ...
    sget-object v0, Lhwo;->k:Ljava/lang/ThreadLocal;
...
.method public static b(Ljava/lang/String;)[Ljava/lang/String;
    ...
    sget-object v0, Lhwo;->c:[Ljava/lang/String;

    :goto_0
    return-object v0

    :cond_0
    sget-object v0, Lhwo;->d:Ljava/util/regex/Pattern;
