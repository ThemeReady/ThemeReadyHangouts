...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lhvh;->a:[Ljava/lang/String;

    sput-boolean v3, Lhvh;->b:Z

    sput-boolean v3, Lhvh;->c:Z
...
.method public static final a(Lhww;)V
    .locals 1

    const-string v0, "(mimetype IN (\'vnd.android.cursor.item/email_v2\',\'vnd.android.cursor.item/phone_v2\'))"

    invoke-virtual {p0, v0}, Lhww;->b(Ljava/lang/String;)V

    return-void
.end method

.method public static final a(Lhww;ZLandroid/content/Context;)V
    .locals 2
    ...
    invoke-static {p2}, Lhvh;->a(Landroid/content/Context;)Z
...
.method private static final declared-synchronized a(Landroid/content/Context;)Z
    ...
    :try_start_0
    sget-boolean v0, Lhvh;->c:Z

    if-eqz v0, :cond_0

    sget-boolean v0, Lhvh;->b:Z
    :try_end_0
    ...
    invoke-static {v2, v3}, Lcom/google/android/apps/hangouts/hangout/StressMode;->g(Ljava/lang/String;Ljava/lang/String;)V
