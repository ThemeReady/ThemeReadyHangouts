...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lhdk;->b:Landroid/content/Context;

    return-void
.end method

.method static declared-synchronized a(Landroid/content/Context;)Lhdk;
    .locals 2
    ...
    invoke-direct {v0, p0}, Lhdk;-><init>(Landroid/content/Context;)V
...
.method private b(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    invoke-static {p1, v0}, Lhdk;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lhdk;->b:Landroid/content/Context;
    ...
    invoke-static {v0}, Lhcu;->b(Landroid/os/Bundle;)V
    ...
    :cond_2
    iget-object v0, p0, Lhdk;->b:Landroid/content/Context;
...
.method private b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Lhdk;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, p0, Lhdk;->b:Landroid/content/Context;
    ...
    :goto_2
    invoke-static {v0}, Lhdk;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method a(Landroid/os/Bundle;)Z
    ...
    invoke-direct {p0, p1, v0}, Lhdk;->b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v7, p0, Lhdk;->b:Landroid/content/Context;
    ...
    .line 1000
    :goto_1
    invoke-direct {p0, p1}, Lhdk;->b(Landroid/os/Bundle;)Landroid/app/PendingIntent;

    move-result-object v7

    new-instance v8, Ldo;

    iget-object v9, p0, Lhdk;->b:Landroid/content/Context;

    invoke-direct {v8, v9}, Ldo;-><init>(Landroid/content/Context;)V

    const/4 v9, 0x1

    invoke-virtual {v8, v9}, Ldo;->e(Z)Ldo;

    move-result-object v8

    invoke-virtual {v8, v3}, Ldo;->a(I)Ldo;
    ...
    invoke-virtual {v3, v5}, Ldo;->b(Ljava/lang/CharSequence;)Ldo;
    ...
    invoke-virtual {v3, v4}, Ldo;->e(I)Ldo;

    :cond_1
    if-eqz v0, :cond_2

    invoke-virtual {v3, v0}, Ldo;->a(Landroid/net/Uri;)Ldo;

    :cond_2
    if-eqz v7, :cond_3

    invoke-virtual {v3, v7}, Ldo;->a(Landroid/app/PendingIntent;)Ldo;

    :cond_3
    invoke-virtual {v3}, Ldo;->b()Landroid/app/Notification;
    ...
    iget-object v8, p0, Lhdk;->b:Landroid/content/Context;
    ...
    invoke-virtual {v3, v4}, Ldo;->a(Ljava/lang/CharSequence;)Ldo;
    :try_end_0
    .catch Lhdl; {:try_start_0 .. :try_end_0} :catch_0
