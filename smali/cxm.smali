...
.method constructor <init>(Landroid/content/Context;Lcus;)V
    ...
    invoke-direct {v0, p0}, Lcxn;-><init>(Lcxm;)V

    iput-object v0, p0, Lcxm;->d:Lcwc;

    .line 42
    new-instance v0, Lcut;

    invoke-direct {v0, p0}, Lcut;-><init>(Lcxm;)V

    iput-object v0, p0, Lcxm;->e:Lcut;

    .line 54
    iput-object p1, p0, Lcxm;->a:Landroid/content/Context;

    .line 56
    iget-object v0, p0, Lcxm;->e:Lcut;
...
.method private b()Z
    ...
    .line 124
    :try_start_0
    iget-object v1, p0, Lcxm;->c:Landroid/media/MediaPlayer;
...
.method a()V
    ...
    .line 100
    iget-object v0, p0, Lcxm;->c:Landroid/media/MediaPlayer;
    ...
    iput-object v0, p0, Lcxm;->c:Landroid/media/MediaPlayer;
    ...
    .line 1075
    :try_start_0
    iget-object v1, p0, Lcxm;->a:Landroid/content/Context;

    iget-object v0, p0, Lcxm;->b:Lcvu;
    ...
    .line 1076
    :goto_0
    invoke-static {v1, v0}, Lgqe;->c(Landroid/content/Context;I)Landroid/net/Uri;
    ...
    iget-object v2, p0, Lcxm;->a:Landroid/content/Context;
