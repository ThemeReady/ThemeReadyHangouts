...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgch;->b:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    sput-object v0, Lgch;->c:Landroid/net/Uri;
    ...
    sput-object v0, Lgch;->e:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public constructor <init>(Landroid/telephony/SmsManager;)V
    ...
    .line 43
    iput-object p1, p0, Lgch;->d:Landroid/telephony/SmsManager;

    .line 44
    return-void
.end method

.method private static a([BLandroid/content/Context;)Lahe;
    .locals 4
    ...
    invoke-direct {v1, p0}, Lagy;-><init>([B)V
    ...
    .line 295
    :goto_0
    invoke-static {p1}, Lgct;->j(Landroid/content/Context;)Z
    ...
    .line 296
    invoke-static {p0, v0, p1}, Lgct;->a([BLago;Landroid/content/Context;)V
...
.method private a(Landroid/content/Context;Ljava/lang/String;)Lgci;
    .locals 12

    .prologue
    .line 151
    sget-boolean v0, Lgch;->a:Z
    ...
    invoke-direct {v4, v0}, Lgci;-><init>(Landroid/net/Uri;)V

    .line 158
    sget-object v1, Lgch;->b:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    .line 171
    :try_start_0
    sget-object v1, Lgch;->e:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 174
    sget-object v1, Lgch;->c:Landroid/net/Uri;
    ...
    .line 181
    invoke-virtual {p0, p1, p2, v0, v2}, Lgch;->a(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;Landroid/content/Intent;)V
    ...
    :cond_3
    :try_start_4
    sget-object v0, Lgch;->e:Ljava/util/concurrent/ConcurrentHashMap;
...
# virtual methods
.method public a(Landroid/content/Context;[BLjava/lang/String;)Lahe;
    .locals 6
    ...
    .line 98
    invoke-direct {p0, p1, p3}, Lgch;->a(Landroid/content/Context;Ljava/lang/String;)Lgci;
    ...
    .line 4302
    :pswitch_0
    iget-object v0, v0, Lgci;->a:Landroid/net/Uri;

    invoke-virtual {p0, v0, p3, p1}, Lgch;->a(Landroid/net/Uri;Ljava/lang/String;Landroid/content/Context;)Lahe;
    ...
    invoke-virtual {v0, p1, p2, p3, v2}, Lgco;->a(Landroid/content/Context;[BLjava/lang/String;I)V
...
.method a(Landroid/net/Uri;Ljava/lang/String;Landroid/content/Context;)Lahe;
    .locals 8
    ...
    :try_start_0
    invoke-static {v0, v4}, Lsb;->a(Ljava/io/File;Z)Ljava/nio/ByteBuffer;

    move-result-object v0

    .line 244
    invoke-static {v0}, Lsb;->a(Ljava/nio/ByteBuffer;)[B
    :try_end_0
    ...
    .line 272
    :cond_1
    invoke-static {v0, p3}, Lgch;->a([BLandroid/content/Context;)Lahe;
    ...
    .line 274
    invoke-static {v3, v0, v2}, Lgqb;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public a(JII)V
    ...
    .line 81
    :try_start_0
    invoke-virtual {v0, p3, p4}, Lgci;->a(II)V
...
.method a(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;Landroid/content/Intent;)V
    ...
    .line 227
    iget-object v0, p0, Lgch;->d:Landroid/telephony/SmsManager;
