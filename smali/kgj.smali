...
# instance fields
.field public final transient a:Lkge;


# direct methods
.method private constructor <init>(Lcom/google/api/client/http/HttpResponseException$Builder;Lkge;)V
    .locals 0
    ...
    .line 56
    iput-object p2, p0, Lkgj;->a:Lkge;

    .line 57
    return-void
.end method

.method public static a(Lcom/google/api/client/json/JsonFactory;Lcom/google/api/client/http/HttpResponse;)Lkgj;
    .locals 7
    ...
    .line 81
    invoke-static {p0}, Lhet;->a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 90
    :try_start_1
    invoke-virtual {v0}, Lkge;->toPrettyString()Ljava/lang/String;
    :try_end_1
    ...
    .line 100
    invoke-static {v0}, Lacn;->V(Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v3, v1}, Lkgj;-><init>(Lcom/google/api/client/http/HttpResponseException$Builder;Lkge;)V
