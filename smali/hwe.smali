...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lhwe;->a:Ljava/util/Map;
    ...
    sget-object v0, Lhwe;->a:Ljava/util/Map;
    ...
    sput-object v0, Lhwe;->b:Landroid/os/Handler;

    const/4 v0, 0x0

    new-array v0, v0, [Ljava/lang/String;

    sput-object v0, Lhwe;->c:[Ljava/lang/String;
    ...
    sput-object v0, Lhwe;->d:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lhwe;->e:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lhwe;->f:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lhwe;->g:Ljava/util/regex/Pattern;

    const-string v0, "\u0001"

    sput-object v0, Lhwe;->h:Ljava/lang/String;

    const-string v0, "\u0002"

    sput-object v0, Lhwe;->i:Ljava/lang/String;

    new-instance v0, Ljava/security/SecureRandom;

    invoke-direct {v0}, Ljava/security/SecureRandom;-><init>()V

    sput-object v0, Lhwe;->j:Ljava/security/SecureRandom;

    new-instance v0, Lhwf;

    invoke-direct {v0}, Lhwf;-><init>()V

    sput-object v0, Lhwe;->k:Ljava/lang/ThreadLocal;

    new-instance v0, Lhwg;

    invoke-direct {v0}, Lhwg;-><init>()V

    sput-object v0, Lhwe;->l:Ljava/lang/ThreadLocal;

    new-instance v0, Lhwh;

    invoke-direct {v0}, Lhwh;-><init>()V

    sput-object v0, Lhwe;->m:Ljava/lang/ThreadLocal;

    new-instance v0, Lhwi;

    invoke-direct {v0}, Lhwi;-><init>()V

    sput-object v0, Lhwe;->n:Ljava/lang/ThreadLocal;

    new-instance v0, Lhwj;

    invoke-direct {v0}, Lhwj;-><init>()V

    sput-object v0, Lhwe;->o:Ljava/lang/ThreadLocal;

    new-instance v0, Lhwk;

    invoke-direct {v0}, Lhwk;-><init>()V

    sput-object v0, Lhwe;->p:Ljava/lang/ThreadLocal;
...
.method public static a()Ljava/lang/StringBuilder;
    ...
    sget-object v0, Lhwe;->k:Ljava/lang/ThreadLocal;
...
.method public static b(Ljava/lang/String;)[Ljava/lang/String;
    ...
    :cond_0
    sget-object v0, Lhwe;->d:Ljava/util/regex/Pattern;
