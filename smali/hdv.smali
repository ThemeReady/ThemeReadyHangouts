...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lhdv;->b:Landroid/content/Context;

    return-void
.end method

.method static declared-synchronized a(Landroid/content/Context;)Lhdv;
    .locals 2
    ...
    invoke-direct {v0, p0}, Lhdv;-><init>(Landroid/content/Context;)V
...
.method private b(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    invoke-static {p1, v0}, Lhdv;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, p0, Lhdv;->b:Landroid/content/Context;
    ...
    invoke-static {v0}, Lhdf;->b(Landroid/os/Bundle;)V
    ...
    :cond_2
    iget-object v0, p0, Lhdv;->b:Landroid/content/Context;
...
.method private b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Lhdv;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, p0, Lhdv;->b:Landroid/content/Context;
    ...
    :goto_2
    invoke-static {v0}, Lhdv;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method a(Landroid/os/Bundle;)Z
    ...
    invoke-direct {p0, p1, v0}, Lhdv;->b(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v7, p0, Lhdv;->b:Landroid/content/Context;
    ...
    :goto_1
    invoke-direct {p0, p1}, Lhdv;->b(Landroid/os/Bundle;)Landroid/app/PendingIntent;

    move-result-object v7

    new-instance v8, Ldx;

    iget-object v9, p0, Lhdv;->b:Landroid/content/Context;

    invoke-direct {v8, v9}, Ldx;-><init>(Landroid/content/Context;)V

    const/4 v9, 0x1

    invoke-virtual {v8, v9}, Ldx;->e(Z)Ldx;

    move-result-object v8

    invoke-virtual {v8, v3}, Ldx;->a(I)Ldx;
    ...
    invoke-virtual {v3, v4}, Ldx;->a(Ljava/lang/CharSequence;)Ldx;
    ...
    invoke-virtual {v3, v5}, Ldx;->b(Ljava/lang/CharSequence;)Ldx;
    ...
    invoke-virtual {v3, v4}, Ldx;->e(I)Ldx;

    :cond_1
    if-eqz v0, :cond_2

    invoke-virtual {v3, v0}, Ldx;->a(Landroid/net/Uri;)Ldx;

    :cond_2
    if-eqz v7, :cond_3

    invoke-virtual {v3, v7}, Ldx;->a(Landroid/app/PendingIntent;)Ldx;

    :cond_3
    invoke-virtual {v3}, Ldx;->b()Landroid/app/Notification;
    ...
    iget-object v8, p0, Lhdv;->b:Landroid/content/Context;
    ...
    invoke-virtual {v3, v4}, Ldx;->a(Ljava/lang/CharSequence;)Ldx;
    :try_end_0
    .catch Lhdw; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v0}, Lhdw;->getMessage()Ljava/lang/String;
