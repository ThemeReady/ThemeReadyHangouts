...
.method static constructor <clinit>()V
    ...
    sget-object v0, Lgya;->c:Ljava/lang/String;

    sput-object v0, Lgxz;->a:Ljava/lang/String;

    sget-object v0, Lgya;->d:Ljava/lang/String;

    sput-object v0, Lgxz;->b:Ljava/lang/String;
...
.method public static a(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2, p3}, Lgxz;->d(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v0, p2, v1}, Lgya;->b(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {p0, v0, p2, p3}, Lgxz;->a(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
...
.method public static b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {p0, v0, p2, p3}, Lgya;->b(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
...
.method public static b(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {v1, p1, v0}, Lgyc;-><init>(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public static c(Landroid/content/Context;Ljava/lang/String;)[Landroid/accounts/Account;
    ...
    invoke-static {}, Lcom/google/android/apps/hangouts/hangout/StressMode;->P()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0, p1}, Lgya;->d(Landroid/content/Context;Ljava/lang/String;)[Landroid/accounts/Account;
...
.method private static d(Landroid/content/Context;Landroid/accounts/Account;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/android/gms/auth/TokenData;
    ...
    .line 6
    invoke-static {p0}, Lgzc;->g(Landroid/content/Context;)V
    :try_end_0
    ...
    invoke-static {v0, p0}, Lgzc;->a(ILandroid/content/Context;)V

    new-instance v0, Lgyg;

    const-string v1, "User intervention required. Notification has been pushed."

    invoke-direct {v0, v1}, Lgyg;-><init>(Ljava/lang/String;)V
