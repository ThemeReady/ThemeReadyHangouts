...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;ZLhaa;Landroid/os/Bundle;Lgyl;Lgym;)V
    .locals 7
    ...
    iput-boolean p3, p0, Lhxj;->a:Z

    iput-object p4, p0, Lhxj;->C:Lhaa;

    iput-object p5, p0, Lhxj;->D:Landroid/os/Bundle;

    invoke-virtual {p4}, Lhaa;->i()Ljava/lang/Integer;

    move-result-object v0

    iput-object v0, p0, Lhxj;->E:Ljava/lang/Integer;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;ZLhaa;Lgyl;Lgym;)V
    .locals 8
    ...
    invoke-virtual {p4}, Lhaa;->a()Landroid/accounts/Account;
    ...
    invoke-virtual {v0}, Lhfo;->e()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lhfo;->f()Z

    move-result v2

    invoke-virtual {v5, v1, v2}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    invoke-virtual {v0}, Lhfo;->g()Ljava/lang/Long;
    ...
    :cond_1
    invoke-virtual {v0}, Lhfo;->h()Ljava/lang/Long;
...
.method public a(Lhaq;Z)V
    .locals 2

    :try_start_0
    invoke-virtual {p0}, Lhxj;->q()Landroid/os/IInterface;

    move-result-object v0

    check-cast v0, Lhxh;

    iget-object v1, p0, Lhxj;->E:Ljava/lang/Integer;

    invoke-virtual {v1}, Ljava/lang/Integer;->intValue()I

    move-result v1

    invoke-interface {v0, p1, v1, p2}, Lhxh;->a(Lhaq;IZ)V
    :try_end_0
...
.method public a(Lhxf;)V
    ...
    .line 2000
    :try_start_0
    iget-object v0, p0, Lhxj;->C:Lhaa;

    invoke-virtual {v0}, Lhaa;->b()Landroid/accounts/Account;
    ...
    .line 2000
    invoke-static {v0}, Lgwz;->a(Landroid/content/Context;)Lgwz;

    move-result-object v0

    invoke-virtual {v0}, Lgwz;->a()Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;
    ...
    iget-object v3, p0, Lhxj;->E:Ljava/lang/Integer;
    ...
    invoke-interface {v0, v1, p1}, Lhxh;->a(Lcom/google/android/gms/signin/internal/SignInRequest;Lhxf;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-interface {p1, v1}, Lhxf;->a(Lcom/google/android/gms/signin/internal/SignInResponse;)V
    :try_end_1
...
.method public k()V
    ...
    invoke-direct {v0, p0}, Lgzx;-><init>(Lgzo;)V

    invoke-virtual {p0, v0}, Lhxj;->a(Lgzu;)V
...
.method protected n()Landroid/os/Bundle;
    ...
    invoke-virtual {v0}, Lhaa;->f()Ljava/lang/String;
    ...
    iget-object v0, p0, Lhxj;->D:Landroid/os/Bundle;

    const-string v1, "com.google.android.gms.signin.internal.realClientPackageName"

    iget-object v2, p0, Lhxj;->C:Lhaa;

    invoke-virtual {v2}, Lhaa;->f()Ljava/lang/String;
